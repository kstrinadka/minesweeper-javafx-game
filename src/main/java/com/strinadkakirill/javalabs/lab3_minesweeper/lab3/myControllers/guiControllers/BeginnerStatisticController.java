...
public class BeginnerStatisticController {
    ...
    void initialize() {
        ...
        GameModes gameMode = GameModes.BEGINNER;
        String fileName = "beginnerStatistic.txt";
        ...
        /*
        1) Cчитать данные с нужного файла

        2) Записать результат в нужные Label
         */
